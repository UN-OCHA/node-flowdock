  ...
  Session = (function(superClass) {
    ...
    Session.prototype._request = async function(method, path, data, cb) {
      ...
      return fetch(uri, options)
        .catch(err => typeof cb === "function" ? cb(err, null, null) : void 0)
        .then(res => res.json())
        // @todo Check null is right for the third parameter.
        .then(body => typeof cb === "function" ? cb(null, body, null) : void 0);
    };
